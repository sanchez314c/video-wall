...
from src.config.settings import DEFAULT_GRID_COLS, DEFAULT_GRID_ROWS
from src.core.animator import TileAnimator
from src.ui.theme import get_central_widget_stylesheet
...
class DisplayManager:
    ...
    def _setup_layout(self):
        ...
        self.central_widget.setStyleSheet(get_central_widget_stylesheet())
    ...
    def initialize_grid(self, animator=True):
        ...
        if animator:
            self.animator = TileAnimator(
                self.tiles, self.grid_layout, self.grid_rows, self.grid_cols, self.video_wall
            )
